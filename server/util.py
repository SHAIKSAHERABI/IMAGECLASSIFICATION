...
def get_b64_test_image_for_budi_mutyala_naidu():
...
if __name__ == '__main__':
    ...
    #print(classify_image(get_b64_test_image_for_budi_mutyala_naidu(), None))

    print(classify_image(None, "./test_images/adimulla suresh.jpg"))
